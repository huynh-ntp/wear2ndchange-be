...
import com.huynhntp.commons.wear2ndchange.model.dto.OrderPlacementResponseDto;
...
public class OrderController {
    ...
    @PostMapping
    @SneakyThrows
    public ResponseEntity<OrderPlacementResponseDto> placeOrder(@RequestBody OrderRequestDto orderRequestDto) {
        ...
        Order createdOrder = orderService.createOrderFromCart(selectedItems, orderRequestDto);

        cartRepository.deleteAll(selectedItems);

        OrderPlacementResponseDto response = OrderPlacementResponseDto.builder()
